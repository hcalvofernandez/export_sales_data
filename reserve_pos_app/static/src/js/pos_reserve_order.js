odoo.define('pos_reserve_order_app.pos_reserve_order', function(require) {
	...
	screens.PaymentScreenWidget.include({
        ...
        // a partir de aca es que podriamos revisar que modificar para lograr que se active la reserva con saldo 0
		...
		reserve_order: function() {
			...
			if (!partner_id){
				...
				return;
				// revisar aqui para poder hacer las reservas con saldo 0
			}
			else{
